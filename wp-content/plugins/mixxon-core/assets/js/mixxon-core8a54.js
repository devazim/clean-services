(function($) {
    ...
    var MixxonLocalTimeZone = new Date().toString().match(/([A-Z]+[\+-][0-9]+.*)/)[1];
    var mixxon_secure = (document.location.protocol === 'https:') ? 'secure' : '';
    document.cookie = "MixxonLocalTimeZone="+MixxonLocalTimeZone+";SameSite=Strict;"+mixxon_secure;
    ...
    $(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/mixxon-countdown.default', CountDown);
        elementorFrontend.hooks.addAction('frontend/element_ready/mixxon-testimonial-carousel.default', TestimonialHandler);
        elementorFrontend.hooks.addAction('frontend/element_ready/mixxon-skill-bar.default', SkillHandler);
        elementorFrontend.hooks.addAction('frontend/element_ready/mixxon-accordian.default', AccordionHandler);
        elementorFrontend.hooks.addAction('frontend/element_ready/mixxon-video-popup.default', VideoPopupHandler);   
    });
})(jQuery);